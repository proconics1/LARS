...
public class ReportGenerator {
	...
	private static final String UNSUPPORTED_FORMAT = "Format unsupported";
...
//			break;
	...
	/**
	 * Can be used to speed up the editing of report templates (.xsl).
	 * @param args
	 */
	...
	private static void usage() {
		System.out.println("-x XML-FILE");
		System.out.println("-r REPORT");
		System.out.println("\twobei REPORT one of");
		System.out.println("\tics: ICS Overview");
		System.out.println("\tmeasures:Prioritized catalog of Measures");
		System.out.println("-f FORMAT");
		System.out.println("\twobei FORMAT one of");
		System.out.printf("\t");
