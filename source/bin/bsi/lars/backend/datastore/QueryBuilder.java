...
/**
 * Class providing the requests.
 * Some requests are buffered to speed up execution.
 * 
 *
 */
public class QueryBuilder {
	...
	/**
	 * This enum is the centerpiece of this class. All requests must be referenced here.
	 * 
	 *
	 */
	public enum queries{
	...
	private QueryBuilder() throws SQLException {
		...
		if(is != null) {
			...
			try {
				queriesList.load(is);
				if(DEBUG) {
					System.out.println("The following requests found in the file:");
	...
	/**
	 * Buffers requests that have been buffered via cached (queries query)
	 * @param query Request
