...
public abstract class Report {
	...
	/**
	 * Hier besteht die Möglichkeit, die Ausgabe der Kategorien zu beeinflussen.
	 * @param categories
	 * @return Gibt die Ausgabe für die übergebenen Kategorien zurück
	 * @throws Exception
	 */
	...
	/**
	 * Hier besteht die Möglichkeit, die Ausgabe der Maßnahmen zu beeinflussen.
	 * @param measures
	 * @return Gibt die Ausgabe für die übergebenen Maßnahmen zurück
	 * @throws Exception
	 */
	protected abstract String generateMeasuresOutput(Vector<Measure> measures) throws Exception;
	
	/**
	 * Hier besteht die Möglichkeit, zusätzliche Daten für den Report zurückzugeben.
	 * @return null, wenn keine weiteren Informationen benötigt werden. Wenn daten zurück gegeben werden, werden diese in den <info></info> Block des generierten XML geschrieben.
	 */
...
//		int[] scorecount = new int[4];
		...
		//Nicht vorhandene Kuchenstücke ausblenden.
		...
		String[] scorenames = new String[]{"KO", "Kritikalität 1", "Kritikalität 2", "Kritikalität 3"};
