...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="report">
			...
			<xsl:choose>
				<xsl:when test="measure">
					<fo:block space-after="4mm" >
						Folgende Maßnahmen sollten verbessert werden, um das Sicherheitsniveau zu erhöhen.
					</fo:block>
					<fo:block>
						<!--fo:table-and-caption-->
						<fo:table table-layout="fixed" width="auto">
						<fo:table-column column-width="110pt" column-number="1" />
						<fo:table-column column-width="110pt" column-number="2" />
						<fo:table-column column-width="175pt" column-number="3" />
			...
			<xsl:template match="measure">
				<xsl:if test="measureanswer/complex != 'umgesetzt'">
					<fo:table-row>
						...
						<fo:table-cell border-bottom-style="solid" border-left-style="solid" margin-left="1mm">
							<fo:block>
	 ...
	 <xsl:template match="answerstatistic">
	    <fo:block break-before="auto" font-size="14.0pt" keep-with-next="always" line-height="115%" space-after="1mm" space-before="4mm" text-align="center">
			<inline xmlns="http://www.w3.org/1999/XSL/Format" font-family="Cambria">Umsetzungsstatus der Maßnahmen</inline>
		</fo:block>
	    <fo:block>
	...
	<xsl:template match="scorestatistic">
		<fo:block break-before="auto" font-size="14.0pt" keep-with-next="always" line-height="115%" space-after="1mm" space-before="4mm" text-align="center">
			<inline xmlns="http://www.w3.org/1999/XSL/Format" font-family="Cambria"><xsl:value-of select="answer" />e Maßnahmen</inline>
		</fo:block>
	    <fo:block>
	 	<fo:instream-foreign-object>
	     <svg:svg width="500" height="300" viewBox="0 0 500 300">
